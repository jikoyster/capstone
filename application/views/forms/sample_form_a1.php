            ...
            <div class="container-fluid">
                <div class="row tab-content">
                    <div>
                        ...
                        <div class="panel panel-success">
                          ...
                          <div class="panel-body">
                            ...
                            <div class="text-success">
                              <table>
                                <tr>
                                  <td><span class="glyphicon glyphicon-check" aria-hidden="true"></span>&nbsp Department Chair notes CES proposal - <strong>January 1, 2015</strong></td>
                                </tr>
                                <tr>
                        ...
                        <button type="button" class="btn btn-xs btn-danger" data-toggle="collapse" data-target="#5_comment"><span class="glyphicon glyphicon-comment"></span>&nbsp Show/Hide Comment</button>
                        <div id="5_comment" class="collapse">
                          <div class="panel panel-body panel-danger">
                            <label class="text-danger">Leigh Mabano - Computer and Information Sciences Chair</label>
                            <p class="text-justify">Lorem ipsum dolor sit amet, usu an legimus vivendum adolescens, pro no vidisse definitiones, quas mundi quo ex. Eam at ullum quidam, omnesque verterem his te.</p>
                            <label class="text-danger">Amanda Quinal - CES Coordinator</label>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" align="center">
                          <a href="<?php echo site_url('Representative/sample_b');?>" style="text-decoration:none">
