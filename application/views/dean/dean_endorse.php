            ...
            <ul class="sidebar-nav">
                ...
                <li>
                  <div align="center">
                    ...
                    <h5 class="designation">School Dean</h5>
                  </div>
                </li>
                <li>
                    <a href="dean_endorse.php"><span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span>&nbsp Endorsements</a>
                </li>
                <li>
                    <a href="dean_setting.php"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>&nbsp Account Settings</a>
                </li>
                <li>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row tab-content">
                    <!-- My Proposals -->
                    <h1><span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span>&nbsp For Endorsement</h1>
                    <hr>
                    <br>
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><a href="dean_sample_form_a.php">Barangay Talamban River Clean-up</a></td>
                            ...
                            <tr>
                                ...
                                <td><a href="dean_sample_form_a_revised.php">Barangay Labangon River Clean-up <span class="badge">revised</span></a></td>
