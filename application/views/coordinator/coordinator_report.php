        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row tab-content">
                    ...
                    <hr>
                    <a href="<?php echo site_url('Coordinator/create_report');?>" style="text-decoration:none"><button class="btn btn-success btn-lg"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span>&nbsp Create Report</button></a>
                    <br>
                    <br>
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><a href="sample_form_d.php">Barangay Talamban River Clean-up</a></td>
                                <td class="text-center">January 1, 2015</td>
                            </tr>
                            <tr>
                                <td class="text-center">2</td>
                                <td><a href="sample_form_e.php">Barangay Talamban River Clean-up</a></td>
                                <td class="text-center">January 1, 2015</td>
                            </tr>
                        </tbody>
                    </table>
