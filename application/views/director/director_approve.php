    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
                    <a href="<?php echo site_url('Director/approved_proposals');?>" class="active"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>&nbsp Approved Proposals</a>
                </li>
                <li>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row tab-content">
                    <!-- My Proposals -->
                    <h1><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>&nbsp Approved Proposals</h1>
                    <hr>
                    <br>
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><a href="director_sample_form_a.php">Barangay Talamban River Clean-up</a></td>
                                <td class="text-center"><a href="" data-toggle="modal" data-target="#leigh_profile">Leigh Mabano</a></td>
                            </tr>
                            <tr>
                                <td class="text-center">2</td>
                                <td><a href="director_sample_form_a_revised.php">Barangay Labangon River Clean-up</a></td>
