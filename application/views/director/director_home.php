        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row tab-content">
                    <!-- My Proposals -->
                    <h1><span class="glyphicon glyphicon-star-empty" aria-hidden="true"></span>&nbsp Endorsed Proposals</h1>
                    <hr>
                    <br>
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="director_sample_form_a_revised.php">Barangay Labangon River Clean-up <span class="badge">revised</span></a></td>
