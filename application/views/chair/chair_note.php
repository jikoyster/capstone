        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row tab-content">
                    <!-- My Proposals -->
                    <h1><span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span>&nbsp Proposals to be Noted</h1>
                    <hr>
                    <br>
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><a href="chair_sample_form_a.php">Barangay Talamban River Clean-up</a></td>
                            ...
                            <tr>
                                ...
                                <td><a href="chair_sample_form_a_revised.php">Barangay Labangon River Clean-up <span class="badge">revised</span></a></td>
